...
**Current Version:** Beta 2.4 (Stable)
...
- **CSV Import Engine:** *Enhanced in Beta 2.4*
    ...
    - **Net Asset Calculation:** *New in Beta 2.4* - Correctly handles "Sold" actions as deductions for Stocks, ETFs, and REITs. Also filters out zero-unit assets.
