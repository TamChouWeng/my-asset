...
**Current Version:** Beta 3.7 (Stable)
...
- **CSV Import Engine:** *Enhanced in Beta 3.7*
    ...
    - **Net Asset Calculation:** *New in Beta 3.7* - Correctly handles "Sold" actions as deductions for Stocks, ETFs, and REITs. Also filters out zero-unit assets.
