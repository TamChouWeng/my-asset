                ...
                <div>
                  ...
                  <select
                    ...
                    onChange={e => {
                      ...
                      const isFixedQty = newType === AssetType.EPF || newType === AssetType.FixedDeposit || newType === AssetType.Property;
              ...
              <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
                ...
                <div>
                  ...
                  <input
                    ...
                    readOnly={formData.type === AssetType.EPF || formData.type === AssetType.FixedDeposit || formData.type === AssetType.Property}
                    onChange={e => handleNumericChange('quantity', e.target.value)}
                    className={formData.type === AssetType.EPF || formData.type === AssetType.FixedDeposit || formData.type === AssetType.Property
